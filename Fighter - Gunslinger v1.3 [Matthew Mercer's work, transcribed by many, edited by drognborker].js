...
AddSubClass("fighter", "gunslinger-v1.3", {
	...
	features : {
		...
		"subclassfeature3.3" : {
			...
			extrachoices : ["Bullying Shot", "Dazing Shot", "Deadeye Shot", "Disarming Shot", "Forceful Shot", "Piercing Shot", "Violent Shot", "Winging Shot", "Intercepting Shot", "Counter Shot"],
			"bullying shot" : {
				name : "Bullying Shot",
				source : ["MM:GMA", 2],
			...
			"intercepting shot" : {
				...
				additional : "1 grit point",
				description : desc([
					"As a reaction when a ranged weapon attack is made by a creature I can see, I make an firearm attack against it.",
					"Projectile AC equals enemy attack roll",
			...
			"counter shot" : {
				...
				source : ["MM:GMA", 2],
				minlevel : 15,
				addtional : "2 grit points",
				description : desc([
					"As a reaction when I can see a spell being cast, I can make a firearm attack at the caster.",
					"They do not take damage, and must make a Constitution save. If failed, the spell is not cast"
				]),
				action : [" reaction ", " "]
			}
		},
